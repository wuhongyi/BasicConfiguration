...
# Last-Updated: 五 8月 20 20:57:18 2021 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 2
# URL: http://wuhongyi.cn 

gccfilename="gcc-7.5.0"
...
./configure --prefix=/opt/GCC/7.5.0 --mandir=/opt/GCC/7.5.0/share/man --infodir=/opt/GCC/7.5.0/share/info --enable-checking=release  --enable-languages=c,c++,fortran --disable-multilib
make -j$num
make install
cd ..
rm -rf ${gccfilename}
