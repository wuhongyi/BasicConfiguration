...
# Last-Updated: 六 9月  7 13:07:06 2024 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 18
...
if [ "$VERSION" = "Release:	20.04" ] ; then 
    ...
    ## Ubuntu1804
    cmake -DCMAKE_INSTALL_PREFIX=${pathinstall}/${name} -DPYTHON_EXECUTABLE=/usr/bin/python3 -DPYTHON_INCLUDE_DIR=/usr/include/python3.10 -Dqt5web=ON -Dwebgui=ON -Droot7=ON -Dfcgi=ON -Dgviz=ON -Dminuit2=ON -Dxrootd=OFF ../$filename2
