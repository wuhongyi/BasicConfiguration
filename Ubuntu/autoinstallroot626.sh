#!/bin/bash
# autoinstallroot626.sh --- 
# 
# Description: 
# Author: Hongyi Wu(吴鸿毅)
# Email: wuhongyi@qq.com 
# Created: 四 4月 19 19:41:34 2018 (+0800)
# Last-Updated: 四 4月 25 17:57:38 2024 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 18
# URL: http://wuhongyi.cn 

filename="root_v6.26.16"
...
if [ "$VERSION" = "Release:	20.04" ] ; then 
    ...
    ## Ubuntu1804
    cmake -DCMAKE_INSTALL_PREFIX=${pathinstall}/${name} -DPYTHON_EXECUTABLE=/usr/bin/python3 -DPYTHON_INCLUDE_DIR=/usr/include/python3.6m -Dqt5web=ON -Dwebgui=ON -DCMAKE_CXX_STANDARD=17 -Droot7=ON -Dfcgi=ON -Dgviz=ON -Dminuit2=ON -Dxrootd=OFF ../$filename2
else 
...
# 
# autoinstallroot626.sh ends here
