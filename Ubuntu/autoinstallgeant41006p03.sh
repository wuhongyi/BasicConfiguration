#!/bin/bash
# autoinstallgeant41006p03.sh --- 
# 
# Description: 
# Author: Hongyi Wu(吴鸿毅)
# Email: wuhongyi@qq.com 
# Created: 三 7月 14 18:27:39 2021 (+0800)
# Last-Updated: 三 7月 14 18:30:51 2021 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 1
# URL: http://wuhongyi.cn 

pathinstall="/opt/Geant4"
filename="geant4.10.06.p03"
...
wget ${urllinkdata}G4EMLOW.7.9.tar.gz            
wget ${urllinkdata}G4PhotonEvaporation.5.5.tar.gz
wget ${urllinkdata}G4RadioactiveDecay.5.4.tar.gz 
wget ${urllinkdata}G4SAIDDATA.2.0.tar.gz         
wget ${urllinkdata}G4PARTICLEXS.2.1.tar.gz       
...
tar -zxvf G4EMLOW.7.9.tar.gz             -C  ${datadir}
tar -zxvf G4PhotonEvaporation.5.5.tar.gz -C  ${datadir}
tar -zxvf G4RadioactiveDecay.5.4.tar.gz  -C  ${datadir}
tar -zxvf G4SAIDDATA.2.0.tar.gz          -C  ${datadir}
tar -zxvf G4PARTICLEXS.2.1.tar.gz        -C  ${datadir}
...
# export G4LENDDATA="`cd $geant4_envbindir/../share/Geant4-10.6.3/data/LEND_GND1.3_ENDF.BVII.1 > /dev/null ; pwd`"

# 
# autoinstallgeant41006p03.sh ends here
