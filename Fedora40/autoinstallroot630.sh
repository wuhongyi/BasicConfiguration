...
cmake -DCMAKE_INSTALL_PREFIX=${pathinstall}/${name} -Dqt5web=ON -Dwebgui=ON -DCMAKE_CXX_STANDARD=17 -Droot7=ON -Dmathmore=ON -Dfftw3=ON -Dfcgi=ON -Dgviz=ON -Dminuit2=ON  -Dxrootd=OFF  ../$filename2
