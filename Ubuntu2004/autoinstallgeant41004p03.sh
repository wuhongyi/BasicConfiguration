#!/bin/bash
# autoinstallgeant41004p03.sh --- 
# 
# Description: 
# Author: Hongyi Wu(吴鸿毅)
# Email: wuhongyi@qq.com 
# Created: 三 2月 20 20:12:07 2019 (+0800)
# Last-Updated: 四 8月 19 18:09:40 2021 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 4
...
wget ${urllinkdata}G4EMLOW.7.3.tar.gz
wget ${urllinkdata}G4PhotonEvaporation.5.2.tar.gz
wget ${urllinkdata}G4RadioactiveDecay.5.2.tar.gz
...
# export G4LENDDATA="`cd $geant4_envbindir/../share/Geant4-10.4.3/data/LEND_GND1.3_ENDF.BVII.1 > /dev/null ; pwd`"

# 
# autoinstallgeant41004p03.sh ends here
