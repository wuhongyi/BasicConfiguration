#!/bin/bash
# autoinstallgeant41005p01.sh --- 
# 
# Description: 
# Author: Hongyi Wu(吴鸿毅)
# Email: wuhongyi@qq.com 
# Created: 五 5月 10 11:35:28 2019 (+0800)
# Last-Updated: 四 8月 19 18:26:38 2021 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 4
...
tar -zxvf G4EMLOW.7.7.tar.gz -C  ${datadir}
tar -zxvf G4PhotonEvaporation.5.3.tar.gz -C  ${datadir}
tar -zxvf G4RadioactiveDecay.5.3.tar.gz -C  ${datadir}
tar -zxvf G4SAIDDATA.2.0.tar.gz -C  ${datadir}
tar -zxvf G4PARTICLEXS.1.1.tar.gz -C  ${datadir}
...
# 
# autoinstallgeant41005p01.sh ends here
