#!/bin/bash
# autoinstallgeant41004beta.sh --- 
# 
# Description: 
# Author: Hongyi Wu(吴鸿毅)
# Email: wuhongyi@qq.com 
# Created: 日 7月  2 16:57:03 2017 (+0800)
# Last-Updated: 日 7月  2 17:29:56 2017 (+0800)
#           By: Hongyi Wu(吴鸿毅)
#     Update #: 2
# URL: http://wuhongyi.cn 

pathinstall="/opt/Geant4"
filename="geant4.10.04.b01"
...
wget http://cern.ch/geant4/support/source/G4EMLOW.6.54.tar.gz
wget http://cern.ch/geant4/support/source/G4PhotonEvaporation.5.0.tar.gz
...
wget http://cern.ch/geant4/support/source/RealSurface.2.1.tar.gz
...
datafilename=`expr $filename | sed 's/geant4./Geant4-/g' | sed 's/\.0/./g' | sed 's/b01/0/g'`
...
tar -zxvf G4EMLOW.6.54.tar.gz -C  ${datadir}
tar -zxvf G4PhotonEvaporation.5.0.tar.gz -C  ${datadir}
...
tar -zxvf RealSurface.2.1.tar.gz -C  ${datadir}
...
# 
# autoinstallgeant41004beta.sh ends here
